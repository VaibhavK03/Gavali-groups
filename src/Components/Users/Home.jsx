            ...
            <div className="absolute inset-0 flex flex-col justify-center items-start px-4 sm:px-12 lg:px-20 text-white">
              ...
              <Link to="/contact">
                <motion.button
                  ...
                  className="mt-6 px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 bg-white/10 backdrop-blur-md border border-white/30 text-white text-sm sm:text-lg lg:text-xl font-semibold rounded-lg hover:bg-white/20 transition-all duration-300"
                >
                  Get In Touch
                </motion.button>
              </Link>

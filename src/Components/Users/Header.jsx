    ...
    <>
      ...
      <div className={`${isMenuOpen ? "block animate-slideDown" : "hidden"} sm:hidden`} id="mobile-menu">
        <div className="space-y-1 px-2 pt-2 pb-3 bg-black">
          <Link to="/about" className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-white active:scale-105">
            About Us
          </Link>
          <Link to="/business" className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-white active:scale-105">
            Businesses
          </Link>
          <Link to="/contact" className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-white active:scale-105">
            Contact Us
          </Link>
        </div>
      </div>
